            ...
            <div className="h-full flex flex-col justify-between text-[var(--forest)]/80 text-base sm:text-lg leading-relaxed">
              <div className="space-y-6">
                ...
                <p>
                  ...
                  things apart, then building small applications, and eventually
                  designing full systems. Each step revealed new patterns and
                  better questions.
                </p>
                ...
                <p>
                  ...
                  together. I believe strong engineers think beyond their
                  immediate domain.
                </p>

                <p>
                  I care deeply about how software evolves over time — how
                  decisions made early affect maintainability, clarity, and the
                  ability to adapt. Writing code is only part of the job;
