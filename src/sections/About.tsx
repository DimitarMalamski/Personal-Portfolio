    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-6 text-[var(--forest)]/80 text-base sm:text-lg leading-relaxed">
          <p>
            Code should be readable. Systems should be understandable. Solutions
            should solve real problems — not just pass tests.
          </p>
          ...
          <p>
            ...
            full systems. Each step revealed new patterns and better questions.
          </p>

          <p>
            When I’m not coding, I’m usually learning about distributed systems,
            sketching interface ideas, or refining how things fit together. I
            believe strong engineers think beyond their immediate domain.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-10">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--forest)]/70">
                Every decision should have a reason. Defaults are still choices.
              </p>
            </div>
